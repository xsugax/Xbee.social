export type TrustTier = 'new' | 'building' | 'established' | 'trusted' | 'authority' | 'diamond' | 'legendary';
export type VerificationType = 'none' | 'identity' | 'authority' | 'government' | 'business' | 'celebrity' | 'creator' | 'official';
