...
CREATE TABLE public.profiles (
  ...
  verification TEXT DEFAULT 'none' CHECK (verification IN ('none','identity','authority','government','business','celebrity','creator')),
  trust_score INTEGER DEFAULT 50 CHECK (trust_score >= 0 AND trust_score <= 100),
  trust_tier TEXT DEFAULT 'new' CHECK (trust_tier IN ('new','building','established','trusted','authority')),
