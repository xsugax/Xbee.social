...
-- ============================================================
INSERT INTO profiles (id, username, display_name, email, avatar, bio, verified, verification, trust_score, trust_tier, badges, streak, followers_count, following_count, created_at) VALUES
(id_elonmusk,     'elonmusk',       'Elon Musk',           'elon@xbee.social',     'https://api.dicebear.com/7.x/initials/svg?seed=EM&backgroundColor=1a1a2e', 'CEO of Tesla, SpaceX, xAI & The Boring Company. Mars is next.', true, 'official', 99, 'legendary', '["verified","pioneer","influencer"]', 365, 195000000, 832, '2024-01-15T00:00:00Z'),
(id_trump,        'realDonaldTrump','Donald J. Trump',      'trump@xbee.social',    'https://api.dicebear.com/7.x/initials/svg?seed=DT&backgroundColor=cc0000', '45th & 47th President of the United States of America. MAGA!', true, 'official', 95, 'legendary', '["verified","influencer"]', 300, 92000000, 51, '2024-01-15T00:00:00Z'),
(id_whitehouse,   'WhiteHouse',     'The White House',      'whitehouse@xbee.social','https://api.dicebear.com/7.x/initials/svg?seed=WH&backgroundColor=002868', 'Welcome to the White House. Tweets may be archived: WH.gov/privacy', true, 'official', 98, 'legendary', '["verified","official"]', 365, 35000000, 12, '2024-01-15T00:00:00Z'),
(id_salmahayek,   'salaboreal',    'Salma Hayek Pinault',   'salma@xbee.social',    'https://api.dicebear.com/7.x/initials/svg?seed=SH&backgroundColor=8B0000', 'Actress. Producer. Mom. Lover of animals and life.', true, 'official', 90, 'diamond', '["verified","creator"]', 200, 25000000, 312, '2024-01-15T00:00:00Z'),
(id_keanureeves,  'KeanuReeves',   'Keanu Reeves',          'keanu@xbee.social',    'https://api.dicebear.com/7.x/initials/svg?seed=KR&backgroundColor=1a1a2e', 'Be excellent to each other.', true, 'official', 97, 'legendary', '["verified","trusted"]', 180, 7200000, 0, '2024-01-15T00:00:00Z'),
(id_charlize,     'CharlizeAfrica','Charlize Theron',       'charlize@xbee.social', 'https://api.dicebear.com/7.x/initials/svg?seed=CT&backgroundColor=5C2D91', 'Actress. Mom. CTAOP Founder helping African youth. UN Messenger of Peace.', true, 'official', 92, 'diamond', '["verified","humanitarian"]', 210, 9500000, 445, '2024-01-15T00:00:00Z'),
(id_rihanna,      'raboreal',      'Rihanna',               'rihanna@xbee.social',  'https://api.dicebear.com/7.x/initials/svg?seed=RH&backgroundColor=FF1493', 'FENTY BEAUTY | SAVAGE X FENTY | Clara Lionel Foundation', true, 'official', 96, 'legendary', '["verified","influencer","creator"]', 365, 110000000, 1302, '2024-01-15T00:00:00Z'),
(id_drake,        'Drake',         'Drake',                  'drake@xbee.social',    'https://api.dicebear.com/7.x/initials/svg?seed=DR&backgroundColor=1DB954', 'Boy Meets World. OVO', true, 'official', 94, 'diamond', '["verified","creator"]', 250, 80500000, 2100, '2024-01-15T00:00:00Z'),
(id_taylorswift,  'taylorswift13', 'Taylor Swift',           'taylor@xbee.social',   'https://api.dicebear.com/7.x/initials/svg?seed=TS&backgroundColor=B22222', 'This is not a brag, this is a thank you letter.', true, 'official', 98, 'legendary', '["verified","influencer","creator"]', 365, 95000000, 0, '2024-01-15T00:00:00Z'),
(id_beyonce,      'Beyonce',       'Beyonce',                'beyonce@xbee.social',  'https://api.dicebear.com/7.x/initials/svg?seed=BY&backgroundColor=C0A062', 'RENAISSANCE world tour. BeyGOOD.', true, 'official', 98, 'legendary', '["verified","influencer","creator"]', 365, 32000000, 1, '2024-01-15T00:00:00Z'),
(id_cristiano,    'Cristiano',     'Cristiano Ronaldo',      'cristiano@xbee.social','https://api.dicebear.com/7.x/initials/svg?seed=CR&backgroundColor=006400', 'Professional footballer. Al Nassr FC & Portugal. SIU!', true, 'official', 99, 'legendary', '["verified","athlete","influencer"]', 365, 112000000, 578, '2024-01-15T00:00:00Z'),
(id_leomessi,     'TeamMessi',     'Leo Messi',              'messi@xbee.social',    'https://api.dicebear.com/7.x/initials/svg?seed=LM&backgroundColor=75AADB', 'Inter Miami CF. Argentina. 8x Ballon d''Or winner. #M10', true, 'official', 99, 'legendary', '["verified","athlete","influencer"]', 300, 17000000, 291, '2024-01-15T00:00:00Z'),
(id_lebron,       'KingJames',     'LeBron James',           'lebron@xbee.social',   'https://api.dicebear.com/7.x/initials/svg?seed=LJ&backgroundColor=552583', 'I am more than an athlete. @Lakers. @SpringHillEnt. 4x Champion.', true, 'official', 97, 'legendary', '["verified","athlete","influencer"]', 300, 53000000, 1050, '2024-01-15T00:00:00Z'),
(id_oprah,        'Oprah',         'Oprah Winfrey',          'oprah@xbee.social',    'https://api.dicebear.com/7.x/initials/svg?seed=OW&backgroundColor=800020', 'Live your best life. @OWNTV @OprahDaily @OprahBookClub', true, 'official', 96, 'legendary', '["verified","influencer","humanitarian"]', 365, 43000000, 315, '2024-01-15T00:00:00Z'),
(id_billgates,    'BillGates',     'Bill Gates',             'bill@xbee.social',     'https://api.dicebear.com/7.x/initials/svg?seed=BG&backgroundColor=00A4EF', 'Sharing things I''m learning through my foundation work and other interests.', true, 'official', 97, 'legendary', '["verified","pioneer","humanitarian"]', 300, 65000000, 522, '2024-01-15T00:00:00Z'),
(id_jeffbezos,    'JeffBezos',     'Jeff Bezos',             'bezos@xbee.social',    'https://api.dicebear.com/7.x/initials/svg?seed=JB&backgroundColor=FF9900', 'Bezos Earth Fund. Blue Origin. The Washington Post. Day 1.', true, 'official', 95, 'legendary', '["verified","pioneer"]', 200, 8200000, 25, '2024-01-15T00:00:00Z'),
(id_markz,        'faboreal',       'Mark Zuckerberg',       'zuck@xbee.social',     'https://api.dicebear.com/7.x/initials/svg?seed=MZ&backgroundColor=1877F2', 'Building Meta. Father. Martial artist.', true, 'official', 93, 'diamond', '["verified","pioneer"]', 250, 14000000, 495, '2024-01-15T00:00:00Z'),
(id_kimk,         'KimKardashian', 'Kim Kardashian',         'kimk@xbee.social',     'https://api.dicebear.com/7.x/initials/svg?seed=KK&backgroundColor=E75480', 'SKIMS. SKKN BY KIM. Law Student. Mom of 4.', true, 'official', 90, 'diamond', '["verified","influencer","creator"]', 300, 75000000, 1300, '2024-01-15T00:00:00Z'),
(id_selenagomez,  'selenagomez',   'Selena Gomez',           'selena@xbee.social',   'https://api.dicebear.com/7.x/initials/svg?seed=SG&backgroundColor=DB7093', 'Rare Beauty founder. Actress. Advocate for mental health.', true, 'official', 93, 'diamond', '["verified","influencer","humanitarian"]', 280, 68000000, 290, '2024-01-15T00:00:00Z'),
(id_justinbieber, 'justinbieber',  'Justin Bieber',          'justin@xbee.social',   'https://api.dicebear.com/7.x/initials/svg?seed=JBB&backgroundColor=9400D3', 'JUSTICE. husband. believer.', true, 'official', 91, 'diamond', '["verified","creator"]', 200, 114000000, 510, '2024-01-15T00:00:00Z'),
(id_therock,      'TheRock',       'Dwayne Johnson',         'therock@xbee.social',  'https://api.dicebear.com/7.x/initials/svg?seed=DJ&backgroundColor=2F4F4F', 'Mana. Gratitude. Tequila. Hardest worker in the room.', true, 'official', 96, 'legendary', '["verified","influencer","creator"]', 350, 40000000, 600, '2024-01-15T00:00:00Z'),
(id_kevinhart,    'KevinHart4real','Kevin Hart',              'kevin@xbee.social',    'https://api.dicebear.com/7.x/initials/svg?seed=KH&backgroundColor=FF6347', 'Comedian. Actor. Entrepreneur. Doing it all, one laugh at a time.', true, 'official', 91, 'diamond', '["verified","creator"]', 250, 38000000, 768, '2024-01-15T00:00:00Z'),
(id_snoopdogg,    'SnoopDogg',     'Snoop Dogg',             'snoop@xbee.social',    'https://api.dicebear.com/7.x/initials/svg?seed=SD&backgroundColor=228B22', 'Boss Dogg. Tha Dogg Father. Nuff said.', true, 'official', 93, 'diamond', '["verified","creator","influencer"]', 300, 23000000, 1200, '2024-01-15T00:00:00Z'),
(id_neymar,       'naboreal',       'Neymar Jr',             'neymar@xbee.social',   'https://api.dicebear.com/7.x/initials/svg?seed=NJ&backgroundColor=FFD700', 'Footballer. Instituto Neymar Jr. @SantosFC heritage.', true, 'official', 90, 'diamond', '["verified","athlete"]', 200, 64000000, 850, '2024-01-15T00:00:00Z'),
(id_katyperry,    'katyperry',     'KATY PERRY',             'katy@xbee.social',     'https://api.dicebear.com/7.x/initials/svg?seed=KP&backgroundColor=FF69B4', 'Love. Light. 143.', true, 'official', 92, 'diamond', '["verified","creator"]', 220, 108000000, 248, '2024-01-15T00:00:00Z'),
(id_ladygaga,     'ladygaga',      'Lady Gaga',              'gaga@xbee.social',     'https://api.dicebear.com/7.x/initials/svg?seed=LG&backgroundColor=9B59B6', 'Born This Way Foundation. Mother Monster. Chromatica.', true, 'official', 95, 'legendary', '["verified","creator","humanitarian"]', 300, 84000000, 130000, '2024-01-15T00:00:00Z'),
(id_arianagrande, 'ArianaGrande',  'Ariana Grande',          'ariana@xbee.social',   'https://api.dicebear.com/7.x/initials/svg?seed=AG&backgroundColor=E6B8C2', 'eternal sunshine. rem beauty. singer tiny person.', true, 'official', 94, 'diamond', '["verified","creator"]', 280, 80000000, 715, '2024-01-15T00:00:00Z'),
(id_tomholland,   'TomHolland1996','Tom Holland',             'tom@xbee.social',      'https://api.dicebear.com/7.x/initials/svg?seed=TH&backgroundColor=CC0000', 'Your friendly neighbourhood Spider-Man. The Brothers Trust.', true, 'official', 88, 'diamond', '["verified","creator"]', 150, 9300000, 623, '2024-01-15T00:00:00Z'),
(id_zendaya,      'Zendaya',       'Zendaya',                'zendaya@xbee.social',  'https://api.dicebear.com/7.x/initials/svg?seed=ZD&backgroundColor=8B008B', 'See me. Hear me. Know me.', true, 'official', 92, 'diamond', '["verified","creator"]', 200, 22000000, 420, '2024-01-15T00:00:00Z'),
(id_willsmith,    'WillSmith',     'Will Smith',             'will@xbee.social',     'https://api.dicebear.com/7.x/initials/svg?seed=WS&backgroundColor=4169E1', 'I''m that dude from Bel-Air. Just livin my life.', true, 'official', 85, 'diamond', '["verified","creator"]', 180, 13000000, 100, '2024-01-15T00:00:00Z'),
(id_timcook,      'timaboreal',      'Tim Cook',              'timcook@xbee.social',  'https://api.dicebear.com/7.x/initials/svg?seed=TC&backgroundColor=555555', 'CEO of Apple. Auburn fan. Views are my own.', true, 'official', 94, 'diamond', '["verified","pioneer"]', 300, 14000000, 87, '2024-01-15T00:00:00Z'),
(id_nasa,         'NASA',          'NASA',                   'nasa@xbee.social',     'https://api.dicebear.com/7.x/initials/svg?seed=NA&backgroundColor=0B3D91', 'There''s space for everybody. Explore: nasa.gov', true, 'official', 99, 'legendary', '["verified","official","pioneer"]', 365, 98000000, 200, '2024-01-15T00:00:00Z'),
(id_ellenshow,    'TheEllenShow',  'Ellen DeGeneres',        'ellen@xbee.social',    'https://api.dicebear.com/7.x/initials/svg?seed=ED&backgroundColor=3498DB', 'Comedian. Be kind to one another.', true, 'official', 88, 'diamond', '["verified","creator"]', 180, 77000000, 570, '2024-01-15T00:00:00Z'),
(id_jackblack,    'jackblack',     'Jack Black',             'jack@xbee.social',     'https://api.dicebear.com/7.x/initials/svg?seed=JBK&backgroundColor=FF4500', 'Actor. Musician. Gamer. Tenacious D. JablinJablin.', true, 'official', 89, 'diamond', '["verified","creator"]', 160, 6200000, 410, '2024-01-15T00:00:00Z'),
(id_ryanreynolds, 'VancityReynolds','Ryan Reynolds',          'ryan@xbee.social',    'https://api.dicebear.com/7.x/initials/svg?seed=RR&backgroundColor=DC143C', 'Wrexham Co-Owner. Aviation Gin. Mint Mobile. Maximum Effort. Mostly dad things.', true, 'official', 93, 'diamond', '["verified","creator","influencer"]', 280, 21000000, 750, '2024-01-15T00:00:00Z'),
(id_margotrobbie, 'MargotRobbie',  'Margot Robbie',          'margot@xbee.social',   'https://api.dicebear.com/7.x/initials/svg?seed=MR&backgroundColor=FFC0CB', 'Actress. Producer. LuckyChap Entertainment.', true, 'official', 88, 'diamond', '["verified","creator"]', 150, 4200000, 90, '2024-01-15T00:00:00Z'),
(id_chrisevans,   'ChrisEvans',    'Chris Evans',            'chris@xbee.social',    'https://api.dicebear.com/7.x/initials/svg?seed=CE&backgroundColor=2E86C1', 'Politically active. Dodger''s dad. A Starting Point.', true, 'official', 90, 'diamond', '["verified","creator"]', 200, 18000000, 310, '2024-01-15T00:00:00Z'),
(id_scarjo,       'ScarlettJo',    'Scarlett Johansson',     'scarjo@xbee.social',   'https://api.dicebear.com/7.x/initials/svg?seed=SJ&backgroundColor=800080', 'Actress. The Outset skincare founder.', true, 'official', 89, 'diamond', '["verified","creator"]', 170, 9500000, 68, '2024-01-15T00:00:00Z'),
(id_jlo,          'JLo',           'Jennifer Lopez',         'jlo@xbee.social',      'https://api.dicebear.com/7.x/initials/svg?seed=JL&backgroundColor=C71585', 'Actress. Singer. Dancer. Producer. Entrepreneur. JLo Beauty.', true, 'official', 91, 'diamond', '["verified","creator","influencer"]', 250, 46000000, 1700, '2024-01-15T00:00:00Z'),
(id_shakira,      'shakira',       'Shakira',                'shakira@xbee.social',  'https://api.dicebear.com/7.x/initials/svg?seed=SK&backgroundColor=E74C3C', 'Singer. Songwriter. Barefoot foundation. Colombian.', true, 'official', 93, 'diamond', '["verified","creator"]', 220, 18000000, 295, '2024-01-15T00:00:00Z'),
(id_msdhoni,      'msdhoni',       'MS Dhoni',               'dhoni@xbee.social',    'https://api.dicebear.com/7.x/initials/svg?seed=MD&backgroundColor=FFFF00', 'Cricket. CSK forever. Captain Cool. Ranchi boy.', true, 'official', 94, 'diamond', '["verified","athlete"]', 180, 41000000, 15, '2024-01-15T00:00:00Z'),
(id_viratkohli,   'imVkohli',      'Virat Kohli',            'virat@xbee.social',    'https://api.dicebear.com/7.x/initials/svg?seed=VK&backgroundColor=003366', 'Cricketer. Father. WROGN. One8. Keep pushing the boundaries.', true, 'official', 95, 'legendary', '["verified","athlete","influencer"]', 300, 61000000, 43, '2024-01-15T00:00:00Z'),
(id_badgalriri,   'badgalriri',    'Rihanna',                'riri@xbee.social',     'https://api.dicebear.com/7.x/initials/svg?seed=RI&backgroundColor=FF1493', 'Fenty Corp. This is an alt.', true, 'official', 88, 'diamond', '["verified","creator"]', 100, 5800000, 800, '2024-01-15T00:00:00Z'),
(id_mrbeast,      'MrBeast',       'MrBeast',                'mrbeast@xbee.social',  'https://api.dicebear.com/7.x/initials/svg?seed=MB&backgroundColor=FF0000', 'Philanthropist. YouTuber. Feastables. I give away money.', true, 'official', 95, 'legendary', '["verified","creator","humanitarian"]', 365, 32000000, 980, '2024-01-15T00:00:00Z'),
(id_pewdiepie,    'pewdiepie',     'PewDiePie',              'pewds@xbee.social',    'https://api.dicebear.com/7.x/initials/svg?seed=PD&backgroundColor=CC0000', 'Swedish YouTuber. Brofist. 111M subs. Semi-retired dad mode.', true, 'official', 90, 'diamond', '["verified","creator"]', 200, 24000000, 680, '2024-01-15T00:00:00Z'),
(id_khloek,       'khloekardashian','Khloe Kardashian',      'khloe@xbee.social',    'https://api.dicebear.com/7.x/initials/svg?seed=KKH&backgroundColor=DDA0DD', 'Good American founder. Mom x2. True crime obsessed.', true, 'official', 85, 'diamond', '["verified","influencer"]', 150, 32000000, 510, '2024-01-15T00:00:00Z'),
(id_kyliejenner,  'KylieJenner',   'Kylie Jenner',           'kylie@xbee.social',    'https://api.dicebear.com/7.x/initials/svg?seed=KJ&backgroundColor=FF69B4', 'Kylie Cosmetics. Kylie Skin. Khy. Mom of 2.', true, 'official', 91, 'diamond', '["verified","influencer","creator"]', 280, 42000000, 420, '2024-01-15T00:00:00Z'),
(id_barackobama,  'BarackObama',   'Barack Obama',           'obama@xbee.social',    'https://api.dicebear.com/7.x/initials/svg?seed=BO&backgroundColor=002147', 'Dad, husband, 44th President. Citizen. Author of A Promised Land.', true, 'official', 99, 'legendary', '["verified","official","humanitarian"]', 365, 133000000, 570000, '2024-01-15T00:00:00Z'),
(id_michelleobama, 'MichelleObama', 'Michelle Obama', 'michelle@xbee.social', 'https://api.dicebear.com/7.x/initials/svg?seed=MO&backgroundColor=8B4513', 'Wife, mother, author, former First Lady. The Light We Carry.', true, 'official', 97, 'legendary', '["verified","official","humanitarian"]', 300, 22000000, 130, '2024-01-15T00:00:00Z'),
(id_brunomars,    'BrunoMars',     'Bruno Mars',             'bruno@xbee.social',    'https://api.dicebear.com/7.x/initials/svg?seed=BM&backgroundColor=FF8C00', 'Singer. Songwriter. Producer. Silk Sonic. SelvaRey Rum lover.', true, 'official', 93, 'diamond', '["verified","creator"]', 250, 35000000, 230, '2024-01-15T00:00:00Z'),
(id_cardi,        'iamcardib',     'Cardi B',                'cardi@xbee.social',    'https://api.dicebear.com/7.x/initials/svg?seed=CB&backgroundColor=FF0000', 'REGULAR DEGULAR GIRL FROM THE BRONX. rapper. mom. wife-ish.', true, 'official', 89, 'diamond', '["verified","creator"]', 200, 30000000, 1700, '2024-01-15T00:00:00Z'),
(id_travisscott,  'traboreal',      'Travis Scott',           'travis@xbee.social',   'https://api.dicebear.com/7.x/initials/svg?seed=TRS&backgroundColor=4B0082', 'UTOPIA. Cactus Jack Records. La Flame.', true, 'official', 87, 'diamond', '["verified","creator"]', 180, 20000000, 350, '2024-01-15T00:00:00Z'),
(id_lizzo,        'lizzo',         'Lizzo',                  'lizzo@xbee.social',    'https://api.dicebear.com/7.x/initials/svg?seed=LZ&backgroundColor=FF1493', 'Singer. Flutist. Body positivity queen. YITTY founder.', true, 'official', 88, 'diamond', '["verified","creator"]', 180, 5200000, 1500, '2024-01-15T00:00:00Z'),
(id_postmalone,   'PostMalone',    'Post Malone',            'post@xbee.social',     'https://api.dicebear.com/7.x/initials/svg?seed=PM&backgroundColor=696969', 'Austin Post. Singer-songwriter. Bud Light lover. Posty.', true, 'official', 87, 'diamond', '["verified","creator"]', 170, 22000000, 620, '2024-01-15T00:00:00Z'),
(id_billieeilish, 'billieeilish',  'Billie Eilish',          'billie@xbee.social',   'https://api.dicebear.com/7.x/initials/svg?seed=BE&backgroundColor=00FF00', 'HIT ME HARD AND SOFT. vegan. climate advocate. she/her.', true, 'official', 91, 'diamond', '["verified","creator","humanitarian"]', 220, 11000000, 880, '2024-01-15T00:00:00Z'),
(id_joebiden,     'JoeBiden',      'Joe Biden',              'biden@xbee.social',    'https://api.dicebear.com/7.x/initials/svg?seed=JBD&backgroundColor=002868', '46th President of the United States. Dad. Grandfather. Irish American.', true, 'official', 94, 'diamond', '["verified","official"]', 300, 38000000, 32, '2024-01-15T00:00:00Z')
