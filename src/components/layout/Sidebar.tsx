...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-[275px] border-r border-theme bg-theme-primary flex flex-col justify-between py-3 px-3 z-40 max-xl:w-[88px] max-lg:hidden">
      ...
      {/* User Profile with Trust */}
      <motion.div
        className="flex items-center gap-3 p-3 rounded-full hover:bg-theme-hover transition-colors cursor-pointer"
        whileHover={{ scale: 1.02 }}
      >
        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-xbee-primary to-xbee-secondary flex items-center justify-center text-white font-bold text-sm shrink-0 relative">
